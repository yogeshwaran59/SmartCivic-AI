...
class Notification(db.Model):
    ...
    type = db.Column(db.String(50), default='new_complaint')  # 'new_complaint' | 'status_update' | 'escalation'
    complaint_id = db.Column(db.String(50), db.ForeignKey('complaints.complaint_id'), nullable=True)
    target_role = db.Column(db.String(20), default='authority')  # 'authority' | 'worker' | 'citizen' | 'all'
